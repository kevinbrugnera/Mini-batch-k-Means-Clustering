...
#Global Variables
RUN_IDENTIFIER = "minibatch_plot"           # Name the output files
...
if __name__ == "__main__":
    ...
    # Load best centroids from JSON file generated by benchmark.py
    stats_df = pd.read_csv(CENTROIDS_PATH)

    centroids_json_string = stats_df['champion_centroids'].iloc[0]

    # Convert the JSON string to a NumPy array of float32
    ...
    # Read dataset and repartition it using global variable
    ...
    # Creates RDD with features and true labels for evaluation
    ...
    #Use designated function to assigned predicted labels
